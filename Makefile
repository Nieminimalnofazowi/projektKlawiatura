...
# Project:  projekt.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile projekt.pro
#############################################################################
...
Makefile: projekt.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/projekt1.0.0 || mkdir -p .tmp/projekt1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projekt1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/projekt1.0.0/ && $(COPY_FILE) --parents mainwindow.h user.h .tmp/projekt1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp user.cpp .tmp/projekt1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/projekt1.0.0/ && (cd `dirname .tmp/projekt1.0.0` && $(TAR) projekt1.0.0.tar projekt1.0.0 && $(COMPRESS) projekt1.0.0.tar) && $(MOVE) `dirname .tmp/projekt1.0.0`/projekt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projekt1.0.0
...
moc_mainwindow.cpp: /usr/include/qt/QtWidgets/QMainWindow \
		...
		/usr/include/qt/QtGui/QTextCursor \
